...
import { fetchEventDetails } from "./components/api";
...
export default function AccessxLayout({ children }) {
  ...
  return (
    <RequireLogin>
      <EventContext.Provider value={{ eventData, loading, error }}>
        <div className="min-h-[100dvh] w-full bg-[#f2f2f2] px-3 pb-8 pt-4 md:px-6">
          <div className="mx-auto w-full max-w-5xl ">
            ...
            {loading && !error && (
              <div className="rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm text-slate-600">
