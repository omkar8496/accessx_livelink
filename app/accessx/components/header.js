...
export default function EventHeader({ event }) {
  ...
  const city = readEventValue(event, ["city", "eventCity", "locationCity"], "");

  const country = readEventValue(event, ["country", "eventCountry"], "");
  ...
  return (
    <header className="mx-auto w-full max-w-5xl pb-4 pt-4">
      <div className="relative overflow-hidden rounded-xl bg-[#f7efea] backdrop-blur shadow-sm">
        <div className="flex flex-col items-center gap-3 p-4 text-center md:flex-row md:items-center md:gap-4 md:p-4 md:text-left">
          ...
          <div className="flex-1 md:text-left">
            ...
            <div className="mt-1 flex min-w-0 items-center gap-2 text-sm font-(--fw-medium) text-slate-500 md:text-base">
              <span className="relative h-3.5 w-3.5 shrink-0 rounded-full bg-(--light-blue) shadow-sm">
